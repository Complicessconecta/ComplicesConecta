  ...
  const statsCards = [
    {
      ...
      change: `+${stats.newUsersToday} hoy`,
      icon: Users,
    ...
    {
      title: "Solicitudes Carrera",
      value: stats.careerApplications,
      change: "Pendientes revisión",
      icon: Mail,
      changeColor: "text-orange-400",
      iconColor: "text-orange-400",
    },
    {
      title: "Solicitudes Moderador",
      value: stats.moderatorRequests,
