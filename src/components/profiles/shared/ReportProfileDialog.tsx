...
export const ReportProfileDialog: React.FC<ReportProfileDialogProps> = ({
  ...
  const reasons = [
    { value: "harassment", label: "Acoso o Intimidación" },
    {
      ...
      label: "Contenido Inapropiado (+18 sin etiqueta)",
    },
    ...
    {
      value: "olympia_law",
      label: "Violación Ley Olimpia (Contenido íntimo sin consentimiento)",
    },
  ...
  const handleNext = async () => {
    if (step === "reason") {
      ...
      try {
        const analysis = await profileReportService.analyzeReportContent(
          reason,
          description,
        );
        ...
        setAiAnalysis(
          "ℹ️ Gracias. Tu reporte ha sido pre-clasificado y será revisado por nuestro equipo de moderación.",
        );
        setStep("ai-check");
      } finally {
        ...
        {step === "ai-check" && (
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-500">
              Al enviar, confirmas que este reporte es verídico. El mal uso de
              esta herramienta puede resultar en sanciones.
            </p>
            <Button
              onClick={handleNext}
        ...
        {step === "success" && (
          <div className="text-center space-y-4 py-6">
            ...
            <p className="text-gray-500">
              Hemos recibido tu reporte. Nuestro equipo de moderación y sistemas
              de IA lo revisarán prioritariamente.
            </p>
