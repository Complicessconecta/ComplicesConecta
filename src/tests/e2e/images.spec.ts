...
test.describe("Sistema de Imágenes", () => {
  ...
  test("debe mostrar galería de perfil", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="upload-image-btn"]'),
    ).toBeVisible();
  });
  ...
  test("debe configurar imagen como privada", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="private-image-indicator"]'),
    ).toBeVisible();
  });
  ...
  test("debe solicitar acceso a imágenes privadías", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="access-request-modal"]'),
    ).toBeVisible();
    await page.fill(
      '[data-testid="access-reason"]',
      "Me gustaría conocer más sobre ustedes",
    );
    await page.click('[data-testid="request-access-btn"]');

    // Verificar confirmación
    await expect(
      page.locator('[data-testid="access-requested"]'),
    ).toBeVisible();
  });
  ...
  test("debe aprobar solicitud de acceso a galería", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="gallery-request-item"]'),
    ).toBeVisible();

    // Aprobar solicitud
    await page
      .locator('[data-testid="approve-gallery-access"]')
      .first()
      .click();
  ...
  test("debe comprimir imágenes automáticamente", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="compression-notice"]'),
    ).toBeVisible();
  ...
  test("debe generar miniaturas automáticamente", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="thumbnail-generated"]'),
    ).toBeVisible();
  ...
  test("debe establecer imagen de perfil principal", async ({ page }) => {
    ...
    // Confirmar selección
    await expect(
      page.locator('[data-testid="main-image-confirmation"]'),
    ).toBeVisible();
    await page.click('[data-testid="confirm-main-image"]');

    // Verificar imagen principal actualizada
    await expect(
      page.locator('[data-testid="main-image-indicator"]'),
    ).toBeVisible();
  });
