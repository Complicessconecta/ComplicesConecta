...
export const HomeProfilesSection = ({
  onOpenActionModal,
}: HomeProfilesSectionProps) => {
  // Generar imágenes únicas por género sin duplicados cercanos
  const femaleImages = getRandomProfileImages("female", 2, {
    width: 500,
    height: 700,
  });
  const maleImages = getRandomProfileImages("male", 2, {
    width: 500,
    height: 700,
  });
        ...
        <div className="text-center space-y-8">
          <div className="space-y-6">
            <h1
              ...
              className="text-[clamp(2.25rem,4vw,3.75rem)] font-bold text-white mb-6 leading-tight animate-slide-up"
            >
            ...
            <p className="text-xl md:text-2xl text-white/95 max-w-4xl mx-auto leading-relaxed animate-slide-up font-medium px-4">
              La plataforma{" "}
              <strong className="text-purple-300">más exclusiva</strong> para la
              comunidad lifestyle mexicana.
