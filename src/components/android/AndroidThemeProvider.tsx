...
const AndroidThemeContext = safeCreateContext<
  AndroidThemeContextType | undefined
>(undefined);
...
export const useAndroidTheme = (): AndroidThemeContextType => {
  ...
  if (!context) {
    throw new Error(
      "useAndroidTheme must be used within an AndroidThemeProvider",
    );
  }
  return context;
};
