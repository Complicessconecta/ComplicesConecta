...
export { default as EditProfileCouple } from '@/components/profiles/couple/EditProfileCouple'
export { default as ProfileCouple } from '@/components/profiles/couple/ProfileCouple'
