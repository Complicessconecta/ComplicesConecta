...
export function initializeDatadogRUM() {
  ...
  const rumEnabled =
    isProduction || import.meta.env.VITE_DATADOG_RUM_ENABLED === "true";
  ...
  try {
    ...
    datadogRum.init({
      ...
      applicationId:
        import.meta.env.VITE_DATADOG_APP_ID || "PLACEHOLDER_APP_ID",
      clientToken:
        import.meta.env.VITE_DATADOG_CLIENT_TOKEN || "PLACEHOLDER_CLIENT_TOKEN",
