...
const demoEvents: EventSlide[] = [
  {
    id: "masks",
    title: "Noches de M├íscaras",
    subtitle: "Fiesta privada en CDMX",
    description: "Encuentros discretos con dress code elegante, m├íscaras venecianas y m├║sica deep house.",
  ...
  },
  {
    ...
    description: "Experiencia allÔÇæinclusive en villa privada con pool parties, cenas tem├íticas y afters selectos.",
    imageUrl: "https://images.unsplash.com/photo-1518459031867-a89b944bffe4?w=1000&auto=format&fit=crop&q=80",
    meta: "Cupo limitado ┬À Dress code blanco",
  },
  {
    id: "dinner",
    title: "Cena Sensorial",
    subtitle: "Restaurante clandestino",
    description: "Maridaje a ciegas con din├ímicas guiadas para parejas afines, m├║sica en vivo y c├│digos privados.",
    imageUrl: "https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=1000&auto=format&fit=crop&q=80",
    meta: "Reservaci├│n previa ┬À Confidencialidad total",
  },
];
