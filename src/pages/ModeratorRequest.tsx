...
const ModeratorRequest = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const { data: existingRequest, error: _checkError } = await (
        supabase as any
      )
      ...
      if (existingRequest) {
        toast({
          ...
          description:
            "Ya tienes una solicitud pendiente. Por favor espera la respuesta del equipo.",
          variant: "destructive",
        });
        return;
      }
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-white/80 mb-6">
                Tu solicitud para convertirte en moderador ha sido enviada
                exitosamente. Nuestro equipo la revisar y te contactaremos
                pronto.
              </p>
              <div className="space-y-4">
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <ul className="text-white/70 text-sm space-y-2 text-left">
                    ...
                    <li>
                      {" "}
                      Podrs acceder al panel de moderacin una vez activado
                    </li>
                  </ul>
                </div>
                <Link to="/">
      ...
      <div className="max-w-2xl mx-auto p-6 pt-24">
        <div className="mb-8">
          ...
          <p className="text-white/80">
            nete a nuestro equipo de moderacin y ayuda a mantener la comunidad
            segura
          </p>
        </div>
        ...
        <Card className="bg-white/10 backdrop-blur-sm border-white/20 mb-6">
          <CardHeader>
            ...
            <CardDescription className="text-white/80">
              nete a nuestro equipo de moderacin y ayuda a crear un espacio
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <ul className="text-white/70 text-sm space-y-2">
                  <li>
                    {" "}
                    <strong>Revisar reportes:</strong> Analizar denuncias de
                    usuarios de manera imparcial
                  </li>
                  <li>
                    {" "}
                    <strong>Moderar contenido:</strong> Evaluar fotos, mensajes
                    y perfiles reportados
                  </li>
                  <li>
                    {" "}
                    <strong>Aplicar sanciones:</strong> Advertencias,
                    suspensiones temporales o permanentes
                  </li>
                  <li>
                    {" "}
                    <strong>Apoyo a usuarios:</strong> Resolver consultas sobre
                    polticas de la comunidad
                  </li>
                  <li>
                    {" "}
                    <strong>Prevencin:</strong> Identificar patrones de
              ...
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <ul className="text-white/70 text-sm space-y-2">
                  ...
                  <li>
                    {" "}
                    <strong>Disponibilidad:</strong> Mnimo 8-10 horas semanales
                  </li>
                  <li>
                    {" "}
                    <strong>Experiencia:</strong> Moderacin online, atencin al
                    cliente o psicologa
                  </li>
                  <li>
                    {" "}
                    <strong>Habilidades:</strong> Comunicacin emptica y toma de
                    decisiones
                  </li>
                  <li>
                    {" "}
                    <strong>Compromiso:</strong> Mnimo 6 meses en el programa
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-lg p-4 border border-green-400/20">
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Funciones exclusivas mientras seas moderador activo
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-white/70">
                    Certificado de moderacin y referencias profesionales
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 rounded-lg p-4">
              ...
              <div className="grid md:grid-cols-4 gap-3 text-xs">
                <div className="text-center">
                  <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-2 text-white font-bold">
                    1
                  </div>
                ...
                <div className="text-center">
                  <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center mx-auto mb-2 text-white font-bold">
                    4
                  </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <label className="text-white/80 text-sm">
                    ...
                    Entiendo que como moderador debo mantener la
                    confidencialidad, actuar de manera imparcial y seguir las
                    polticas de la comunidad. *
                  </label>
                </div>
              </div>
              ...
              <p className="text-white/60 text-xs text-center">
                * Campos obligatorios. Tu informacin ser revisada por nuestro
                equipo.
              </p>
            </form>
          </CardContent>
