      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Elementos en cola</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {moderationStats.approvalRate.toFixed(1)}%
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {moderationStats.averageResponseTime.toFixed(1)}m
            </div>
          ...
          {moderationResult && selectedItem ? (
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-2">
                      <Badge
                        variant={getSeverityColor(moderationResult.severity)}
                      >
                  ...
                  <div>
                    ...
                    <Progress
                      value={moderationResult.confidence * 100}
                      className="mt-2"
                    />
                  </div>
            ...
            <Card>
              <CardContent className="text-center py-8">
                ...
                <h3 className="text-lg font-medium">
                  No hay resultados de moderación
                </h3>
                <p className="text-muted-foreground">
                  Selecciona un elemento de la cola para ver los resultados
                </p>
              </CardContent>
            </Card>
          )}
