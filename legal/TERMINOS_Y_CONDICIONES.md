# 📜 Términos y Condiciones de Uso - ComplicesConecta
...
Al acceder y usar ComplicesConecta ("la Aplicación", "el Servicio", "nosotros"), usted ("el Usuario", "tú") acepta estar legalmente vinculado por estos Términos y Condiciones.
...
- Abusos o acoso a otros usuarios
- Sospecha de ser menor de edad
...
- ❌ Spam, malware, o contenido malicioso
...
- Usuarios son responsables de su contenido
...
- ❌ Vender servicios sexuales (la app NO es para prostitución)
- ❌ Realizar estafas o fraudes
...
- Violaciones graves: Ban inmediato + reporte legal
...
- Usar nuestro nombre/marca sin permiso
...
- ❌ Resultados específicos (matches, conexiones)
...
- ❌ Problemas técnicos de dispositivos de terceros
...
- ❌ NO somos responsables de lo que ocurra offline
...
**Contacto privacidad:** privacy@complicesconecta.com
...
## 17. ACEPTACIÓN EXPRESA

**AL HACER CLIC EN "ACEPTO" O AL USAR LA APLICACIÓN, DECLARAS QUE:**
...
_Estos términos fueron redactados para proteger tanto a los usuarios como a la plataforma. Si tienes dudas, consulta con un abogado._

**ComplicesConecta® - Todos los derechos reservados.**
