          ...
          <div className="space-y-6">
            ...
            <div className="border rounded-lg p-4 bg-gray-50">
              ...
              {!showFullTerms ? (
                <div className="text-sm text-gray-700 space-y-2">
                  <p>
                    • <strong>Edad mínima:</strong> Debes ser mayor de 18 años
                    para usar ComplicesConecta
                  </p>
                  <p>
                    • <strong>Uso responsable:</strong> Prohibido contenido
                    ofensivo, spam o acoso
                  </p>
                  <p>
                    • <strong>Veracidad:</strong> La información del perfil debe
                    ser real y actualizada
                  </p>
                  <p>
                    • <strong>Respeto:</strong> Trata a otros usuarios con
                    cortesía y respeto
                  </p>
                  <p>
                    • <strong>Seguridad:</strong> No compartas información
                    personal sensible
                  </p>
                </div>
              ) : (
                <div className="text-sm text-gray-700 space-y-3 max-h-40 overflow-y-auto">
                  ...
                  <p>
                    Debes tener al menos 18 años de edad para crear una cuenta.
                    Si eres menor de edad, no puedes usar este servicio.
                  </p>

                  <h4 className="font-medium">3. Conducta del Usuario</h4>
                  <p>
                    Te comprometes a usar la plataforma de manera responsable,
                    sin acosar, amenazar o enviar contenido inapropiado a otros
                    usuarios.
                  </p>
                  ...
                  <p>
                    No compartas información personal como números de teléfono,
                    direcciones o datos financieros con otros usuarios.
                  </p>
                </div>
              )}
            ...
            <div className="border rounded-lg p-4 bg-gray-50">
              ...
              {!showFullPrivacy ? (
                <div className="text-sm text-gray-700 space-y-2">
                  <p>
                    • <strong>Datos recopilados:</strong> Información de perfil,
                    fotos, mensajes y actividad
                  </p>
                  <p>
                    • <strong>Uso de datos:</strong> Mejorar el servicio, hacer
                    matches y comunicación
                  </p>
                  <p>
                    • <strong>Compartir datos:</strong> Solo con otros usuarios
                ...
                <div className="text-sm text-gray-700 space-y-3 max-h-40 overflow-y-auto">
                  ...
                  <p>
                    ...
                    como datos de perfil, fotos, mensajes y preferencias.
                  </p>

                  <h4 className="font-medium">2. Cómo Usamos tu Información</h4>
                  <p>
                    Usamos tus datos para crear tu perfil, sugerir matches
                    compatibles, facilitar la comunicación y mejorar nuestros
                    servicios.
                  </p>

                  <h4 className="font-medium">3. Compartir Información</h4>
                  <p>
                    Tu información de perfil se comparte con otros usuarios
                    según tu configuración de privacidad. No vendemos tus datos
                    a terceros.
                  </p>
                  ...
                  <p>
                    Puedes acceder, corregir o eliminar tu información personal
                    en cualquier momento desde tu perfil o contactándonos.
                  </p>
                </div>
              )}
            ...
            {(!termsAccepted || !privacyAccepted) && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <p className="text-sm text-yellow-800">
                  <strong>Importante:</strong> Debes aceptar tanto los Términos
                  de Uso como la Política de Privacidad para continuar con el
                  registro.
                </p>
              </div>
            )}
