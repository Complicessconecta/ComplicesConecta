        ...
        <div className="flex items-center mb-8">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-3xl font-bold text-white">
              Ley Olimpia - Protección Digital
            </h1>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-white/10 border-red-400/30">
              ...
              <CardContent className="text-white/90 space-y-4">
                <p>
                  La <strong>Ley Olimpia</strong> es un conjunto de reformas
                  legislativas en México que reconocen la
                  <strong> violencia digital</strong> como un delito. Fue
                  nombrada en honor a Olimpia Coral Melo, activista que luchó
                  contra la difusión no consensuada de contenido íntimo.
                </p>
                <p>
              ...
              <CardContent className="text-white/90 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-orange-500/20 p-4 rounded-lg border border-orange-400/30">
                    ...
                    <p className="text-sm">
                      Actuamos inmediatamente ante reportes de violencia
                      digital.
                    </p>
                  </div>
                  <div className="bg-red-500/20 p-4 rounded-lg border border-red-400/30">
                    ...
                    <p className="text-sm">
                      Sancionamos severamente cualquier violación a la
                      privacidad.
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="text-white/90">
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <span className="text-cyan-400 mr-2">•</span>
                    <span>
                      <strong>Encriptación de datos:</strong> Protección
                      avanzada de información personal
                    </span>
                  </li>
                </ul>
              </CardContent>
            ...
            <Card className="bg-red-500/20 border-red-400/50">
              ...
              <CardContent className="text-white/90 space-y-4">
                <p className="text-sm text-center">
                  Si eres víctima de violencia digital o conoces un caso,
