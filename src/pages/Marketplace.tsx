...
const Marketplace = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      description:
        "Paquete de 10 Super Likes para destacar tu inters y aumentar tus posibilidades de match.",
      price: 150,
      currency: "CMPX",
      category: "romantic",
      image:
    ...
    },
    {
      ...
      description:
        "Haz que tu perfil aparezca en las primeras posiciones durante 24 horas para maximizar tu visibilidad.",
      price: 99,
      currency: "CMPX",
      category: "premium",
      image:
    ...
    },
    {
      ...
      description:
        "Regalo virtual exclusivo con efectos especiales para sorprender a tus conexiones.",
      price: 75,
      currency: "CMPX",
      category: "romantic",
      image:
    ...
    },
    {
      ...
      description:
        "Acceso prioritario a eventos VIP exclusivos con descuentos especiales y beneficios nicos.",
      price: 199,
      currency: "CMPX",
      category: "luxury",
      image:
        "https://images.unsplash.com/photo-1519167758481-83f142bb8cba?w=400&h=300&fit=crop&crop=center",
      rating: 5.0,
      reviews: 156,
      badge: "Exclusivo",
      features: [
        ...
        <main className="container mx-auto px-4 py-8 pt-24">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Descubre productos y servicios premium diseados para mejorar tu
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {filteredProducts.map((product) => (
              <Card
                key={product.id}
                className="bg-card/80 backdrop-blur-sm border border-primary/10 overflow-hidden hover:scale-105 transition-transform"
              >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="bg-linear-to-r from-fuchsia-500/20 to-purple-600/20 backdrop-blur-sm border border-fuchsia-400/30">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Super Likes, regalos virtuales, y boost de perfil para
                    maximizar tus conexiones romnticas.
                  </p>
                  <div className="flex items-center justify-between">
                    <div className="text-2xl font-bold text-white">
                      299 CMPX
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Explora nuestra tienda y elige el producto que mejor se
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-white mb-2">
                      Paga con Tokens CMPX
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      Usa tus tokens CMPX para realizar la compra de forma
                      segura e instantnea
                    </p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Recibe tu producto inmediatamente y mejora tu experiencia
                      en la plataforma
                    </p>
                  </div>
                </div>
            ...
            <Card className="bg-linear-to-r from-fuchsia-500/20 to-purple-600/20 backdrop-blur-sm border border-fuchsia-400/30">
              <CardContent className="p-8">
                ...
                <p className="text-xl text-white/90 mb-6 max-w-2xl mx-auto">
                  Compra tokens CMPX para acceder a todos los productos premium
                  del marketplace
                </p>
