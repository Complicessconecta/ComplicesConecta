...
export const ButtonSize = z.enum(["sm", "md", "lg", "xl"]);

// Validación de colores - NO permitir blancos/negros puros
export const ColorValidator = z.string().refine(
  (color) => {
  ...
  {
    message:
      "No se permiten colores blancos o negros puros. Usar gradientes o colores con transparencia.",
  },
);
...
export const TextProps = z
  ...
  .refine(
    ...
    {
      message:
        "Usar text-gray-700 dark:text-gray-200 o superior para mejor contraste",
    },
  );
