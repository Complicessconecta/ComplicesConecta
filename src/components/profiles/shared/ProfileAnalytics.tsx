...
export const ProfileAnalytics = () => {
  ...
  const maxPhotoLikes = Math.max(
    ...mockAnalytics.engagement.bestPhotos.map((p) => p.likes),
  );
    ...
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-foreground">
                  {mockAnalytics.overview.profileViews}
                </p>
              </div>
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-foreground">
                  {mockAnalytics.overview.matches}
                </p>
              </div>
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-foreground">
                  {mockAnalytics.overview.messages}
                </p>
              </div>
      ...
      <Card className="shadow-soft">
        ...
        <CardContent className="pt-0">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-3">
            <div>
              <p className="text-2xl sm:text-3xl font-bold text-foreground">
                {mockAnalytics.overview.profileScore}/100
              </p>
              <Badge
                variant="secondary"
                className={getScoreColor(mockAnalytics.overview.profileScore)}
              >
          ...
          <Progress
            value={mockAnalytics.overview.profileScore}
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-sm font-medium">
                        {mockAnalytics.engagement.responseRate}%
                      </span>
                    </div>
                    <Progress
                      value={mockAnalytics.engagement.responseRate}
                      className="h-2"
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                    <div>
                      ...
                      <p className="font-semibold">
                        {mockAnalytics.engagement.averageResponseTime}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">
                      ...
                      <p className="font-semibold">
                        {mockAnalytics.engagement.bestTimeToSwipe}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {maxPhotoLikes > 0
                          ? Math.round((photo.likes / maxPhotoLikes) * 100)
                          : 0}
                        % engagement
                      </p>
                    </div>
