 ...
 * ARCHIVO EN CUARENTENA (NO USAR EN PRODUCCIÓN)
 *
 * - Este archivo fue movido aquí por detección de duplicado.
 * - No debe importarse desde el código productivo.
 * - El canónico equivalente vive en: src/components/modals/ContentModerationModal.tsx
 *
