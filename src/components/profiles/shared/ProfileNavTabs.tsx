  ...
  useEffect(() => {
    ...
    const formattedMatches = results.matches.map((match) => {
      ...
      return {
        ...
        accountType: (candidate?.gender === "pareja" ? "couple" : "single") as
          | "single"
          | "couple",
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/90 text-sm">
                        Disfrutando de un día increíble y conociendo nuevos
                        lugares ✨
                      </p>
                    </div>
                    {isOwnProfile && (
              ...
              <div className="flex flex-wrap gap-4 mb-4 p-4 bg-white/5 rounded-xl border border-white/10">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    logger.info("NFT image selected", {
                      name: file.name,
                      size: file.size,
                      type: file.type,
                    });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {matches.map((match) => (
                  <MatchCard
                    ...
                    onSuperLike={() =>
                      handleMatchAction(match.id, "super-like")
                    }
