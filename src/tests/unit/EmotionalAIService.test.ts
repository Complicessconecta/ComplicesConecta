      ...
      const mockSelect = vi.fn().mockReturnValue({
        or: vi.fn().mockReturnValue({
          order: vi.fn().mockReturnValue({
            limit: vi.fn().mockResolvedValue({
              data: [
                { content: 'Te odio', sender_id: '1', created_at: '2023-01-01' },
                { content: 'Eres lo peor', sender_id: '2', created_at: '2023-01-01' },
       ...
       const mockSelect = vi.fn().mockReturnValue({
        or: vi.fn().mockReturnValue({
          order: vi.fn().mockReturnValue({
            limit: vi.fn().mockResolvedValue({
              data: [
                { content: 'Genial gracias', sender_id: '1', created_at: '2023-01-01' },
                { content: 'Me gusta mucho', sender_id: '2', created_at: '2023-01-01' },
                { content: 'Claro que sí', sender_id: '1', created_at: '2023-01-01' }
              ],
              error: null
            })
          })
