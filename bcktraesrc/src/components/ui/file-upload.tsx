...
export const FileUpload: React.FC<FileUploadProps> = ({
  className,
  label = "Verificaci├│n de Identidad (KYC)",
  description = "Sube una foto de tu identificaci├│n oficial. Se usa solo para validar tu mayor├¡a de edad y se protege bajo nuestras pol├¡ticas de privacidad y consentimiento.",
  onChange,
}) => {
