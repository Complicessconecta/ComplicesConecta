...
export const ProfileThemeShowcase: React.FC<ProfileThemeShowcaseProps> = ({
  ...
  const [selectedProfileType, setSelectedProfileType] =
    useState<ProfileType>("single");
  const [selectedGender, setSelectedGender] = useState<Gender>("male");
  const [selectedPartnerGender, setSelectedPartnerGender] =
    ...
    <div className={cn("space-y-8", className)}>
      ...
      >
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Descubre cómo los perfiles se adaptan visualmente según el género,
          tipo de relación y tema seleccionado. Cada combinación crea una
          ...
          <div className="space-y-4">
            ...
            {selectedTheme && (
              <ThemePreviewCard
                ...
                className="w-full"
                {...((selectedProfileType === "couple" && selectedPartnerGender ? { partnerGender: selectedPartnerGender } : {}) as any)}
              />
            )}
            ...
            <div className="text-sm text-gray-600 space-y-1">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                ...
                <li>
                  Géneros:{" "}
                  {selectedGender === "male" ? "Masculino" : "Femenino"}
                  {selectedProfileType === "couple" &&
      ...
      <UnifiedCard className="p-6 bg-gradient-to-r from-purple-50 to-pink-50">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-700">
          <div>
            ...
            <p>
              Los perfiles single adaptan automáticamente sus colores según el
              género: tonos azules/grises para masculino, púrpuras/rosas para
              femenino.
            </p>
          </div>
          <div>
            ...
            <p>
              Las parejas tienen fondos especiales según la combinación:
              hombre+mujer (púrpura-azul), mismo género (tonos coordinados).
            </p>
          </div>
          <div>
            <h4 className="font-medium text-purple-700 mb-2">
            ...
            <p>
              Los usuarios pueden elegir temas adicionales (Elegante, Moderno,
              Vibrante) que sobrescriben los colores por defecto.
            </p>
          </div>
        </div>
      </UnifiedCard>
