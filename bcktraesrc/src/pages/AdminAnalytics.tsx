 ...
 * =====================================================
 * P├ígina de an├ílisis y monitoreo para administradores
 * Fecha: 2025-10-29
 * Versi├│n: v3.4.1
 * =====================================================
 */
...
export const AdminAnalytics: React.FC = () => {
  useEffect(() => {
    logger.info('­ƒôè Admin Analytics page loaded');
  }, []);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-lg">
              Monitoreo en tiempo real de m├®tricas de performance, errores y Web Vitals
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700 p-6">
              ...
              <p className="text-gray-400 text-sm">
                Monitoreo de tiempos de carga, interacci├│n y uso de memoria en tiempo real.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700 p-6">
              ...
              <p className="text-gray-400 text-sm">
                Captura y categorizaci├│n de errores con alertas configurables por severidad.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700 p-6">
              ...
              <p className="text-gray-400 text-sm">
                Seguimiento de Core Web Vitals (LCP, FCP, FID, CLS, TTFB) seg├║n est├índares de Google.
              </p>
            </div>
          </div>
        </div>
