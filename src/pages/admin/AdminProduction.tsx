  ...
  useEffect(() => {
    ...
    if (demoAuth === "true" && demoUser) {
      try {
        ...
        logger.info(" Actualizando estado premium para usuario:", {
          userId: user.id,
          email: user.email,
          role: user.role,
        });
  ...
  const loadRealStats = async () => {
    try {
      ...
      setStats({
        ...
        premiumUsers: premiumUsers || 0,
        totalMatches:
          getMetricValue("total_matches") ||
          Math.floor((totalUsers || 0) * 0.3),
        apkDownloads: apkDownloadsResponse.count || 0,
        dailyVisits:
          getMetricValue("daily_visits") || Math.floor((totalUsers || 0) * 0.4),
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-white/70">
              Gestión completa de la plataforma ComplicesConecta
            </p>
          </div>
        </div>
                    ...
                    <div key={faq.id} className="p-4 bg-white/5 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <Badge className="text-xs border border-white/30 bg-transparent text-white">
