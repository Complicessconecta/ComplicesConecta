...
export function AdvancedAnalyticsDashboard() {
  const { dashboard, isLoading, error, refreshDashboard, resolveAlert } =
  ...
  const { allInsights, retentionInsights, conversionInsights } =
  ...
  const [_selectedTimeRange, _setSelectedTimeRange] = useState<
    "1h" | "24h" | "7d" | "30d"
  >("24h");
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Dashboard completo de métricas, insights predictivos y alertas en
            tiempo real
          </p>
        </div>
      ...
      {(criticalAlerts.length > 0 || highAlerts.length > 0) && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            {criticalAlerts.length} alertas críticas y {highAlerts.length}{" "}
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              <span className="ml-1">
                {trends ? Math.abs(trends.userGrowth).toFixed(1) + "%" : "0%"}{" "}
                vs período anterior
              </span>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              <span className="ml-1">
                {trends
                  ? Math.abs(trends.engagementTrend).toFixed(1) + "%"
                  : "0%"}{" "}
                vs período anterior
              </span>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              <span className="ml-1">
                {trends ? Math.abs(trends.errorTrend).toFixed(1) + "%" : "0%"}{" "}
                vs período anterior
              </span>
            </div>
          </CardContent>
          ...
          <CardContent>
            ...
            <Progress
              value={
                realTimeMetrics
                  ? Math.min(
                      (realTimeMetrics.averageResponseTime / 2000) * 100,
                      100,
                    )
                  : 0
              }
                  ...
                  <>
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {formatNumber(realTimeMetrics.apiCalls)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-muted-foreground">
                      ...
                      <span className="font-medium">
                        {formatPercentage(realTimeMetrics.cacheHitRate)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-muted-foreground">
                  ...
                  <>
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        <span>Hit Rate</span>
                        <span>
                          {formatPercentage(cachePerformance.hitRate)}
                        </span>
                      </div>
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        <span>Miss Rate</span>
                        <span>
                          {formatPercentage(cachePerformance.missRate)}
                        </span>
                      </div>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {cachePerformance.averageAccessTime.toFixed(1)}ms
                      </span>
                    </div>
                  </>
                )}
