...
export const AdaptiveBackground = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-br from-slate-900 via-purple-950 to-slate-900" />

      {/* Capa Dinámica según Gama */}
      {tier === "low" ? (
        <div className="absolute inset-0 opacity-50 bg-[radial-gradient(circle_at_50%_50%,rgba(76,29,149,0.3),transparent_70%)]" />
      ) : (
