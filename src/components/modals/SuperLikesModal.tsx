        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-white font-medium text-sm drop-shadow-md">
              Los Super Likes te permiten mostrar interés especial y aparecer
              primero en la lista de la otra persona.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 bg-white/10 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-white/90 font-medium drop-shadow-sm">
                  Reciben una alerta de tu interés
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-white/10 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-white/90 font-medium drop-shadow-sm">
                  Mayor probabilidad de conexión
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 p-4 rounded-lg border border-orange-500/30">
            <div className="flex items-center justify-between mb-2">
              ...
              <Badge
                variant="secondary"
                className="bg-orange-500/30 text-orange-300 border-orange-400/50 font-medium"
              >
                5 / día
              </Badge>
            </div>
