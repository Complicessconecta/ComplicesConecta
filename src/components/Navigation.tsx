            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  "min-w-[45px] sm:min-w-[55px] w-[45px] sm:w-[55px] min-h-[50px] sm:min-h-[60px] group shrink-0",
              ...
              >
                ...
                <Icon
                  className={cn(
                    "w-4 h-4 sm:w-5 sm:h-5 mb-0.5 sm:mb-1 transition-all duration-300 relative z-10 shrink-0",
                    isActive
