...
|   +---lifestyle
|   |       couple-beach-1.svg
|   |       couple-lifestyle-1.svg
|   |       couple-lifestyle-2.svg
|   |       
|   \---svg
|           creative-icon.svg
|           flujo-trabajo-completo.svg
...
|   |   |   AdminNav.tsx
|   |   |   AdvancedModerationPanel.tsx
|   |   |   AlertConfigPanel.tsx
|   |   |   AnalyticsDashboard.tsx
|   |   |   AnalyticsPanel.tsx
|   |   |   DesktopNotificationSettings.tsx
|   |   |   ExportButton.tsx
|   |   |   HistoricalCharts.tsx
|   |   |   index.ts
|   |   |   ModerationMetrics.tsx
...
|   |   |       PrivateImageRequestsManager.tsx
|   |   |       profile.ts
...
|   |       
|   +---clubs
|   |       clubFlyerImageProcessing.ts
|   |       
|   +---permissions
|   |       PermissionManager.tsx
|   |       
|   \---profile
|           coupleProfilesCompatibility.ts
...
|   |   \---patterns
|   |           explicitTerms.ts
|   |           harassmentPatterns.ts
|   |           inappropriateWords.ts
|   |           personalInfoPatterns.ts
|   |           spamPatterns.ts
|   |           
|   +---other
|   |       index.ts
...
|   |           |   index.ts
|   |           |   PredictiveGraphMatchingService.ts
|   |           |   types.ts
|   |           |   utils.ts
|   |           |   
|   |           \---models
...
|   |   |   
|   |   \---nft
|   |           NFTVerificationService.ts
|   |           PolygonStubService.ts
|   |           
|   +---rag
|   |       index.ts
|   |       RAGService.ts
...
|   |   |   clubs.spec.ts
|   |   |   comments.spec.ts
|   |   |   components-theme.spec.ts
|   |   |   critical-flows.spec.ts
|   |   |   cross-browser.spec.ts
|   |   |   demo-flow.spec.ts
|   |   |   demo-vs-real.spec.ts
...
|   |   |   requests.spec.ts
|   |   |   staking-nfts.spec.ts
|   |   |   stories.spec.ts
|   |   |   tokens-system.spec.ts
...
|   |   |   ContentProtectionService.test.ts
|   |   |   emailService.test.ts
|   |   |   EmotionalAIService.test.ts
|   |   |   HistoricalMetricsService.test.ts
|   |   |   invitations.test.ts
...
|   |   |   PyTorchScoringModel.test.ts
|   |   |   realtime-chat.test.ts
|   |   |   ReportService.test.ts
|   |   |   roles.test.ts
|   |   |   SecurityService.test.ts
|   |   |   TokenAnalyticsService.test.ts
|   |   |   UserIdentificationService.test.ts
|   |   |   UserVerificationService.test.ts
|   |   |   useToast.test.ts
|   |   |   webVitals.test.ts
...
|       supabase-final.ts
|       supabase-fixes.ts
|       supabase-generated-club-ecosystem.ts
