...
export const InstallAppModal = ({ isOpen, onClose }: InstallAppModalProps) => {
  ...
  const currentInstructions =
    instructions[browser as keyof typeof instructions] || instructions.chrome;
        ...
        <div className="relative">
          ...
          <div className="bg-hero-gradient p-4 sm:p-6 text-white text-center rounded-t-lg">
            ...
            {isAPK ? (
              ...
              <>
                <h2 className="text-xl sm:text-2xl font-bold mb-2">
                  ¡Instala ComplicesConecta!
                </h2>
                <p className="text-white/90 mb-3 sm:mb-4 text-sm sm:text-base">
                  Sigue estos pasos para instalar nuestra app en tu dispositivo
                  Android
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
                  <Badge
              ...
              <div className="space-y-4 text-center">
                <div className="bg-green-900/30 border border-green-500/30 rounded-lg p-4">
                  ...
                  <p className="text-sm text-green-100 mb-3">
                    ComplicesConecta está funcionando correctamente en tu
                    dispositivo Android.
                  </p>
                ...
                <div className="bg-blue-900/30 border border-blue-500/30 rounded-lg p-4">
                  ...
                  <div className="space-y-1 text-xs text-blue-100">
                    ...
                    <p>
                      🔧 Standalone: {platformInfo.isStandalone ? "Sí" : "No"}
                    </p>
                  </div>
                </div>
              ...
              <>
                ...
                <div className="bg-amber-900/30 border border-amber-500/30 rounded-lg p-3 sm:p-4">
                  <div className="flex items-start space-x-2">
                    <div className="text-amber-400 mt-0.5 text-sm sm:text-base">
                      ⚠️
                    </div>
                  ...
                  <Button
                    onClick={() => {
                      try {
                        ...
                        logger.error("Error al descargar APK:", {
                          error:
