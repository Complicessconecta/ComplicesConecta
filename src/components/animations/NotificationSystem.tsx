...
const NotificationContext =
  safeCreateContext<NotificationContextType>(undefined);
...
export const MatchNotification: React.FC<{
...
export const AchievementNotification: React.FC<{ achievement: any }> = ({
  achievement,
}) => {
  const { addNotification } = useNotifications();
...
export const FloatingHearts: React.FC<{ count?: number }> = ({ count = 5 }) => {
  ...
  return <div className="fixed inset-0 pointer-events-none z-40">{hearts}</div>;
};
