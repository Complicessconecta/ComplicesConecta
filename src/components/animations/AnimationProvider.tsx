...
// Create context
export const AnimationContext = safeCreateContext<
...
export const AnimationProvider: React.FC<AnimationProviderProps> = ({
  ...
  const [config, setConfig] = useState<AnimationConfig>(() => {
    ...
    const savedConfig = safeGetItem<Partial<AnimationConfig>>(
      "animation-config",
      { validate: false, defaultValue: {} },
    );
    const parsedConfig =
    ...
    const finalConfig = {
      ...
      enableParticles:
        parsedConfig.enableParticles !== false
          ? true
          : parsedConfig.enableParticles,
    };
  ...
  const updateConfig = useCallback(
    (newConfig: Partial<AnimationConfig>) => {
      ...
      safeSetItem("animation-config", updatedConfig, {
        validate: false,
        sanitize: true,
      });
    },
  ...
  const triggerGlobalAnimation = useCallback(
