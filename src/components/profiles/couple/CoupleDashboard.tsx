...
export const CoupleDashboard: React.FC = () => {
      ...
      const mockEvents: CoupleEvent[] = [
        {
          ...
          description:
            "Cena elegante para parejas swinger en restaurante exclusivo",
          event_type: "dinner",
          location: "Madrid, España",
  ...
  const handleJoinEvent = async (eventId: string) => {
    try {
      ...
      const success = await advancedCoupleService.joinCoupleEvent(
        eventId,
        coupleProfile.id,
      );
        ...
        setCoupleEvents((prev) =>
          prev.map((event) =>
            event.id === eventId
              ? {
                  ...event,
                  participants: [...event.participants, coupleProfile.id],
                }
              : event,
          ),
        );
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {coupleProfile.statistics.total_views}
            </div>
            <p className="text-xs text-muted-foreground">Perfil visto</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">
              {coupleProfile.statistics.total_likes}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              {coupleProfile.statistics.total_matches}
            </div>
            <p className="text-xs text-muted-foreground">Parejas compatibles</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {coupleProfile.statistics.total_messages}
            </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge
                      variant={getExperienceLevelColor(
                    ...
                    <Badge
                      variant={getRelationshipTypeColor(
                  ...
                  <div>
                    ...
                    <Progress
                      value={coupleProfile.statistics.profile_completeness}
                      className="mt-2"
                    />
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-sm text-muted-foreground">
                        {(
                          coupleProfile.compatibility_factors
                  ...
                  <div>
                    ...
                    <Progress
                      value={
                        coupleProfile.compatibility_factors.personality_match *
                        100
                      }
                    />
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-sm text-muted-foreground">
                        {(
                          coupleProfile.compatibility_factors.lifestyle_match *
                          100
                        ).toFixed(1)}
                        %
                      </span>
                ...
                {nearbyCouples.length > 0 ? (
                    ...
                    <div key={couple.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge variant="outline">
                            {(
                              couple.compatibility_factors.compatibility_score *
                              100
                            ).toFixed(0)}
                            % match
                          </Badge>
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-medium">
                      No hay parejas cercanas
                    </h3>
                    <p className="text-muted-foreground">
                      Intenta ampliar tu rango de búsqueda
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                {coupleMatches.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground">
                      Explora parejas cercanas para encontrar matches
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                {coupleEvents.length > 0 ? (
                    ...
                    <div key={event.id} className="border rounded-lg p-4">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        >
                          ...
                          {event.participants.includes(coupleProfile.id)
                            ? "Unido"
                            : "Unirse"}
                        </Button>
                      </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground">
                      Crea un evento o espera a que aparezcan nuevos
                    </p>
                  </div>
                )}
              </div>
