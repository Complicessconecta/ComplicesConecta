...
const REPORT_REASONS: {
...
}[] = [
  {
    ...
    description: "Comportamiento agresivo, amenazas o acoso",
    icon: AlertTriangle,
    color: "text-red-500",
  },
  {
  ...
  {
    id: "fake-profile",
    label: "Perfil falso o información engañosa",
    description: "Información falsa o perfil ficticio",
    icon: Shield,
  ...
  },
  {
    ...
    description: "Actividad fraudulenta o estafa",
    icon: CreditCard,
  ...
  },
  {
    id: "underage",
    label: "Menor de edad",
    description: "Usuario menor de 18 años",
    icon: Baby,
    color: "text-pink-500",
  },
  {
    id: "other",
    label: "Otro motivo",
    description: "Otra violación de las normas",
    icon: Flag,
    color: "text-gray-500",
  },
];
...
export const ProfileReportModal: React.FC<ProfileReportModalProps> = ({
  ...
  const [step, setStep] = useState<"reason" | "details" | "confirmation">(
    "reason",
  );
              ...
              {step === "reason" && (
                ...
                >
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                    ¿Por qué estás reportando este perfil?
                  </p>
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        {React.createElement(reason.icon, {
                          className: `w-5 h-5 mt-0.5 ${reason.color} group-hover:scale-110 transition-transform`,
                        })}
                        <div>
              ...
              {step === "details" && selectedReasonData && (
                ...
                >
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    {React.createElement(selectedReasonData.icon, {
                      className: `w-5 h-5 ${selectedReasonData.color}`,
                    })}
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-white">
