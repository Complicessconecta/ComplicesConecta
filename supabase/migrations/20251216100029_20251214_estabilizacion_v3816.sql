-- ============================================================================
-- MIGRACIÓN DE ESTABILIZACIÓN - ComplicesConecta v3.8.16
-- ============================================================================
-- Fecha: 2025-12-14
-- Propósito: Crear tablas de acuerdos, disputas y consentimientos de forma segura
-- Seguridad: 100% idempotente - puede ejecutarse múltiples veces sin error
-- ============================================================================

-- ============================================================================
-- FASE 1: CREAR TABLAS BASE (IF NOT EXISTS)
-- ============================================================================

-- Tabla: couple_agreements - Acuerdos prenupciales entre parejas
...
-- RESUMEN
-- ============================================================================
-- ✓ 5 tablas creadas (couple_agreements, couple_disputes, frozen_assets, user_consents, consent_evidence)
-- ✓ 5 columnas agregadas (agreement_id, dispute_id, consent_status, etc.)
