...
const Blog = () => {
  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Aprende las mejores prcticas para conectar de manera segura y discreta en la comunidad lifestyle. Conoce las nuevas features: Verificador IA de Consentimiento, Galerias NFT-Verificadías, Matching Predictivo con Neo4j y Eventos Virtuales Sostenibles.",
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-purple-600 via-fuchsia-500 to-indigo-600">
      {/* Header */}
      ...
      <div className="container mx-auto px-4 py-16">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-linear-to-r from-purple-500 to-fuchsia-500 text-white px-3 py-1 rounded-full text-sm font-medium">
                    {post.category}
                  </span>
                </div>
              </div>
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-8 mt-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            />
            <Button className="px-8 bg-linear-to-r from-purple-500 to-fuchsia-500 hover:from-purple-600 hover:to-fuchsia-600">
              Suscribirse
            </Button>
          </div>
        </div>
