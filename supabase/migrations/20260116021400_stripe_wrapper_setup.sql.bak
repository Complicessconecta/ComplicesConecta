-- ============================================================================
-- STRIPE WRAPPER CONFIGURATION FOR COMPILICESCONECTA
-- Autor: DevOps Senior Expert - 16 Ene 2026
-- Basado en: https://supabase.com/docs/guides/database/extensions/wrappers/stripe
-- ============================================================================

-- ============================================================================
-- PASO 1: INSTALAR EXTENSIONES REQUERIDAS
-- ============================================================================
-- Necesario para FDW y Vault
CREATE EXTENSION IF NOT EXISTS wrappers;
CREATE EXTENSION IF NOT EXISTS vault;

-- ============================================================================
-- PASO 2: CREAR SCHEMA PRIVADO 'stripe'
-- ============================================================================
...
-- ============================================================================
-- PASO 3: ALMACENAR STRIPE SECRET KEY EN VAULT
-- ============================================================================
-- NUNCA almacenar secrets en texto plano o variables de entorno
-- Usar Supabase Vault para producción

-- Crear vault para Stripe (si no existe)
-- Esto se hace desde el dashboard o via API, no SQL directo
-- Documentación: https://supabase.com/docs/guides/platform/vault

-- Simulación: Asumimos que el secret ya está en Vault con ID 'stripe_secret_key'
-- En producción, usar: vault.insert('stripe_secret_key', 'sk_live_...')
-- Para desarrollo, usar: vault.insert('stripe_secret_key', 'sk_test_...')

-- ============================================================================
-- PASO 4: CREAR FOREIGN DATA WRAPPER PARA STRIPE
-- ============================================================================
-- Usar vault para autenticación
CREATE FOREIGN DATA WRAPPER stripe_wrapper
  HANDLER stripe_fdw_handler
  VALIDATOR stripe_fdw_validator;

-- ============================================================================
-- PASO 5: CREAR SERVER CON VAULT
-- ============================================================================
-- El secret key se obtiene dinámicamente desde Vault
CREATE SERVER stripe_server
  FOREIGN DATA WRAPPER stripe_wrapper
  OPTIONS (
    api_key_id 'stripe_secret_key'  -- ID del secret en Vault
  );

-- ============================================================================
-- PASO 6: IMPORTAR FOREIGN SCHEMA (TODAS LAS TABLAS ÚTILES)
-- ============================================================================
-- Importamos las tablas principales de Stripe
...
-- ============================================================================
-- PASO 7: CREAR MATERIALIZED VIEWS PARA PERFORMANCE
-- ============================================================================
-- Para datos semi-estáticos: products y prices
-- Queries FDW son lentas (~300-320ms), materialized views cachean datos
...
-- ============================================================================
-- PASO 8: CREAR ÍNDICES EN MATERIALIZED VIEWS
-- ============================================================================
...
-- ============================================================================
-- PASO 9: CREAR TABLA LOCAL PARA MAPPING USER → STRIPE_CUSTOMER
-- ============================================================================
...
-- ============================================================================
-- PASO 10: CREAR VIEWS EN 'public' CON RLS PARA EXPOSICIÓN SEGURA
-- ============================================================================
...
-- ============================================================================
-- PASO 11: APLICAR RLS A TABLA user_stripe_customers
-- ============================================================================
...
-- ============================================================================
-- PASO 12: CREAR SECURITY DEFINER FUNCTIONS PARA QUERIES COMPLEJAS
-- ============================================================================
...
BEGIN
  ...
  -- Crear customer en Stripe vía FDW
...
-- ============================================================================
-- PASO 13: CREAR TABLA LOCAL PARA WEBHOOK EVENTS (ENFOQUE HÍBRIDO)
-- ============================================================================
...
-- ============================================================================
-- PASO 14: CREAR FUNCTION PARA PROCESAR WEBHOOK EVENTS
-- ============================================================================
...
-- ============================================================================
-- PASO 15: CONFIGURAR PG_CRON PARA REFRESH AUTOMÁTICO (OPCIONAL)
-- ============================================================================
-- Instalar pg_cron si no está instalado
-- CREATE EXTENSION IF NOT EXISTS pg_cron;

-- Programar refresh de materialized views cada hora
...
-- ============================================================================
-- PASO 17: CREAR TABLA DE CONFIGURACIÓN DE PRODUCTOS CMPX
-- ============================================================================
