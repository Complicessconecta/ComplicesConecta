...
test.describe("Login de Administrador", () => {
  ...
  test("debe mostrar panel de administración completo", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="profiles-section"]'),
    ).toBeVisible();
    await expect(
  ...
  test("debe mostrar estadísticas de usuarios", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="new-registrations"]'),
    ).toBeVisible();
  ...
  test("debe permitir gestión de usuarios", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="edit-user-btn"]').first(),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="delete-user-btn"]').first(),
    ).toBeVisible();
  });
  ...
  test("debe permitir moderación de contenido", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="reported-content"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="pending-approvals"]'),
    ).toBeVisible();
  });
  ...
  test("debe validar permisos específicos de admin", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="system-settings-btn"]'),
    ).toBeVisible();
