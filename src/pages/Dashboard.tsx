...
const DashboardCore = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-blue-900 flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <div data-testid="loading-dashboard" className="sr-only">
            Loading
          </div>
        </div>
      </div>
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-blue-900 relative overflow-hidden"
    ...
    >
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 max-w-full overflow-x-hidden">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h1
            className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-4 px-2"
...
const Dashboard = () => {
  ...
  if (import.meta.env.DEV) {
    debugLog(
      "🎯 Dashboard: Componente principal inicializando con ErrorBoundary",
    );
  }
