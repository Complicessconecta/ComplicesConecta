...
import { INAPPROPRIATE_WORDS } from "@/lib/moderation/patterns/inappropriateWords";
import { PERSONAL_INFO_PATTERNS } from "@/lib/moderation/patterns/personalInfoPatterns";
import { EXPLICIT_TERMS } from "@/lib/moderation/patterns/explicitTerms";
import { HARASSMENT_PATTERNS } from "@/lib/moderation/patterns/harassmentPatterns";
import { SPAM_PATTERNS } from "@/lib/moderation/patterns/spamPatterns";
...
class ContentModerationEngine {
  ...
  private readonly INAPPROPRIATE_WORDS = INAPPROPRIATE_WORDS;
  private readonly SPAM_PATTERNS = SPAM_PATTERNS;
  private readonly PERSONAL_INFO_PATTERNS = PERSONAL_INFO_PATTERNS;
  ...
  private calculateExplicitnessScore(text: string): number {
    const explicitTerms = EXPLICIT_TERMS;
  ...
  private detectHarassment(text: string): number {
    const harassmentPatterns = HARASSMENT_PATTERNS;
