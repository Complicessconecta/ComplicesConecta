  ...
  const features = [
    {
      ...
      description:
        "Verificación de identidad, encriptación end-to-end y protección de datos personales.",
    ...
    },
    {
      ...
      description:
        "Solo perfiles auténticos y verificados. Sin bots ni perfiles falsos.",
      color: "text-blue-400",
    },
    {
      ...
      description:
        "Algoritmo inteligente que conecta personas con intereses y valores compatibles.",
    ...
    },
    {
      ...
      description:
        "Control total sobre tu información. Solo compartes lo que quieres.",
      color: "text-purple-400",
    },
    {
    ...
    },
    {
      ...
      description:
        "Conecta con personas de todo México y expande tu red social.",
      color: "text-cyan-400",
    },
  ];
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white font-medium max-w-3xl mx-auto drop-shadow-lg">
              Conoce más sobre CómplicesConecta, la plataforma social más
              exclusiva y segura para la comunidad swinger en México
            </p>
          </div>
          ...
          <section className="mb-16">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                <Card
                  key={index}
                  className="bg-purple-800/90 backdrop-blur-sm border border-purple-500/30 text-center shadow-lg"
                >
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <Card
                  key={index}
                  className="bg-purple-800/90 backdrop-blur-sm border border-purple-500/30 shadow-lg"
                >
                  <CardContent className="p-6">
              ...
              <CardContent className="space-y-6">
                <div className="text-center">
                  <p className="text-lg text-white font-medium max-w-4xl mx-auto leading-relaxed drop-shadow-md">
                    CómplicesConecta es la plataforma social más exclusiva y
                    segura diseñada específicamente para la comunidad swinger
                    mexicana. Nuestra misión es crear un espacio donde parejas y
                    solteros puedan conectar de manera auténtica, discreta y
                    verificada.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-white font-medium leading-relaxed drop-shadow-sm">
                      Crear la comunidad swinger más exclusiva y segura de
                      México, donde las conexiones auténticas y el respeto mutuo
                      son los pilares fundamentales de nuestra plataforma.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white mb-4 drop-shadow-md">
            ...
            <Card className="bg-linear-to-r from-purple-600/90 to-blue-700/90 backdrop-blur-sm border border-purple-400/50 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-xl text-white font-medium mb-6 max-w-2xl mx-auto drop-shadow-md">
                  Descubre conexiones auténticas en un ambiente seguro y
                  discreto diseñado especialmente para ti
                </p>
