...
const StoriesContainer: React.FC = () => {
  ...
  const isAuthenticated = () => {
    return (
      isDemoMode() ||
      safeGetItem<string>("authenticated", {
        validate: true,
        defaultValue: "false",
      }) === "true"
    );
        ...
        const demoStories: Story[] = [
          ...
          },
          {
            ...
            user: {
              name: "Roberto & Sofía",
              avatar:
                "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=100&h=100&fit=crop&crop=faces&auto=format&q=80",
            },
            location: "Puebla",
          },
          {
        ...
        <Card className="bg-black/30 backdrop-blur-sm border-white/10 p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg leading-relaxed max-w-3xl mx-auto">
              Comparte momentos auténticos que desaparecen automáticamente en 24
              horas. Conecta de manera más íntima y espontánea con otros
              miembros de la comunidad swinger mexicana.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="text-center p-4 bg-white/5 rounded-lg">
              ...
              <p className="text-white/70 text-sm">
                Control total sobre quién ve tus historias
              </p>
            </div>
            <div className="text-center p-4 bg-white/5 rounded-lg">
              ...
              <p className="text-white/70 text-sm">
                Reacciones y comentarios privados
              </p>
            </div>
          </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-white/70 text-sm">
            Momentos que desaparecen en 24 horas
          </p>
        </div>
            ...
            >
              ...
              <div className="absolute top-2 right-2 flex flex-col gap-1">
                ...
                {story.visibility === "private" && (
                  <Badge
                    variant="outline"
                    className="text-xs px-1 py-0 border-yellow-500 text-yellow-400"
                  >
