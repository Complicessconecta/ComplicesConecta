-- ============================================
-- Ecosistema de Clubes - Tablas SQL Consolidadas
...
-- 3. Tabla token_transactions
-- Nota: La tabla ya existe, solo se agregan índices y RLS si no existen
...
UNION ALL
SELECT
  'club_ratings' as table_name,
  COUNT(*) as row_count
FROM club_ratings
UNION ALL
SELECT
  'trust_contacts' as table_name,
  COUNT(*) as row_count
FROM trust_contacts;
