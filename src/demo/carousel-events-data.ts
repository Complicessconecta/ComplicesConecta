...
export const demoEvents: EventSlide[] = [
  {
    ...
    description:
      "Encuentros discretos con dress code elegante, máscaras venecianas y música deep house.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Experiencia all‑inclusive en villa privada con pool parties, cenas temáticas y afters selectos.",
    imageUrl:
      "https://images.unsplash.com/photo-1518459031867-a89b944bffe4?w=1000&auto=format&fit=crop&q=80",
