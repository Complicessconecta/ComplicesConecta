  ...
  const buttonVariants = [
    {
      ...
      hoverEffect:
        "before:absolute before:inset-0 before:bg-white/20 before:translate-x-[-100%] before:transition-transform before:duration-300 group-hover:before:translate-x-0",
    },
    {
      name: "Diagonal Swipe",
      className: "btn-diagonal-swipe relative overflow-hidden group",
      hoverEffect:
        "before:absolute before:inset-0 before:bg-white/20 before:translate-x-[-100%] before:skew-x-12 before:transition-transform before:duration-300 group-hover:before:translate-x-0",
    },
    {
      name: "Scale & Glow",
    ...
    },
    {
      ...
      hoverEffect:
        "before:absolute before:bottom-0 before:left-0 before:w-full before:h-0 before:bg-white/20 before:transition-all before:duration-300 group-hover:before:h-full",
    },
    {
      name: "Ripple",
      className: "btn-ripple relative overflow-hidden group",
      hoverEffect:
        "after:absolute after:top-1/2 after:left-1/2 after:w-0 after:h-0 after:bg-white/30 after:rounded-full after:transition-all after:duration-300 group-hover:after:w-full group-hover:after:h-full after:-translate-x-1/2 after:-translate-y-1/2",
    },
  ];

  return (
    <div
      className={cn("p-8 rounded-lg", themeConfig.backgroundClass, className)}
    >
      ...
      <div className="mt-12 p-6 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10">
        ...
        <p className={cn("text-sm mb-4", themeConfig.accentClass)}>
          Estos efectos están integrados con el sistema de temas v2.8.3 y se
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button
            variant="outline"
            className="btn-animated hover:scale-105 border-white/20 text-white hover:bg-white/10"
          >
            Outline Style
          </Button>
          <Button
