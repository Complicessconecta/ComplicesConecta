...
const CoupleProfileCard = ({
  ...
  const partner1Avatar =
    profile.couple_images?.[0] ||
    "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=600&fit=crop&crop=face";
  const partner2Avatar =
    profile.couple_images?.[1] ||
          ...
          <div className="relative overflow-hidden">
            {!imageError && partner1Avatar ? (
              <img
                ...
                onLoad={() =>
                  logger.info("Partner 1 image loaded successfully:", {
                    image: partner1Avatar,
                  })
                }
              />
            ) : (
          ...
          <div className="relative overflow-hidden">
            {!imageError && partner2Avatar ? (
              <img
                ...
                onError={() => setImageError(true)}
                onLoad={() =>
                  logger.info("Partner 2 image loaded successfully:", {
                    image: partner2Avatar,
                  })
                }
              />
            ) : (
