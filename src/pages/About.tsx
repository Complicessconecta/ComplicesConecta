          ...
          <Card className="bg-white/10 backdrop-blur-md border-white/20 shadow-2xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-xl text-white/90 font-medium leading-relaxed mb-6">
                La plataforma social líder en México para adultos que buscan
                conexiones auténticas en el lifestyle swinger. Conecta con
                parejas y solteros verificados en un ambiente seguro, discreto y
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-6">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <p className="text-gray-100 text-xs font-medium">
                    AI-Native - Neo4j - Production Ready
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="bg-white/10 backdrop-blur-md border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                ...
                <p className="text-white font-medium leading-relaxed">
                  Crear un espacio seguro donde parejas y solteros del lifestyle
                  swinger puedan conectar de manera autntica, explorando nuevas
                  experiencias con total discrecin y respeto mutuo.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                ...
                <p className="text-white font-medium leading-relaxed">
                  Convertirnos en una plataforma confiable para la comunidad
                  lifestyle en México, reconocida por brindar un ambiente
                  seguro, tecnologa moderna y compromiso con la privacidad de
                  nuestros usuarios.
                </p>
              </CardContent>
            </Card>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  ...
                  <p className="text-gray-100 text-sm font-medium">
                    Comparte momentos que desaparecen en 24 horas con total
                    privacidad
                  </p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  ...
                  <p className="text-gray-100 text-sm font-medium">
                    Algoritmo avanzado que conecta según compatibilidad y
                    preferencias
                  </p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  ...
                  <p className="text-gray-100 text-sm font-medium">
                    Sistema 2FA con autenticación facial y huella digital
                  </p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                ...
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  ...
                  <p className="text-gray-100 text-sm font-medium">
                    Detección proactiva de consentimiento en chats con IA
                  </p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  <Award className="h-8 w-8 text-yellow-400 mb-3" />
                  <h4 className="font-semibold text-white mb-2">
                    Matching Predictivo con Graphs
                  </h4>
                  <p className="text-gray-100 text-sm font-medium">
                    Neo4j + IA para conexiones "friends-of-friends" emocionales
                  </p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors">
                  ...
                  <p className="text-gray-100 text-sm font-medium">
                    Eventos eco-friendly con recompensas CMPX
                  </p>
                </div>
              </div>
            </CardContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Todos los datos estn protegidos con cifrado militar de
                        grado empresarial
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Documento oficial + selfie + verificacin telefnica
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Moderadores humanos especializados en lifestyle y
                        relaciones
                      </p>
                    </div>
                  </div>
