  ...
  const swingerFeatures = [
    {
      ...
      description:
        "Verificación de identidad + validación de experiencia swinger para comunidad auténtica",
      status: "Activo",
    },
    {
      icon: MessageSquare,
    ...
    },
    {
      ...
      description:
        "Localiza parejas swinger y clubs exclusivos cerca de tu ubicación",
      status: "Activo",
    },
    {
      icon: Calendar,
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Gestiona tu experiencia swinger: conexiones, eventos privados y
              estadísticas de tu vida íntima
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <Card className="bg-white/5 backdrop-blur-xl border border-white/15 rounded-2xl shadow-xl">
              ...
              <CardContent className="p-6 md:p-10">
                <div className="text-2xl font-bold text-foreground">
                  {swingerStats.totalCouples}
                </div>
                <p className="text-xs text-white/80">
                  <span className="text-accent">+15%</span> parejas nuevas este
                  mes
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/5 backdrop-blur-xl border border-white/15 rounded-2xl shadow-xl">
              ...
              <CardContent className="p-6 md:p-10">
                <div className="text-2xl font-bold text-foreground">
                  {swingerStats.intimateConnections}
                </div>
                <p className="text-xs text-white/80">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/80">
                Personaliza tu experiencia en ComplicesConecta
              </p>
            </div>
          ...
          <Card className="bg-hero-gradient border-0 text-white">
            ...
            <CardContent className="text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  className="bg-linear-to-r from-purple-600 to-fuchsia-600 hover:from-purple-700 hover:to-fuchsia-700 text-white font-semibold px-6 py-3 text-lg shadow-lg"
