  ...
  const premiumFeatures = [
    {
      ...
      description:
        "Destaca sin límites con todos los perfiles que te interesen",
        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-white font-medium text-sm drop-shadow-md">
              Accede a funciones exclusivas y vive experiencias únicas en la
              comunidad swinger más premium.
            </p>
          </div>
          ...
          <div className="bg-linear-to-r from-yellow-500/20 to-orange-500/20 p-4 rounded-lg border border-yellow-500/30">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-sm text-white/70 line-through font-medium">
                $599
              </span>
