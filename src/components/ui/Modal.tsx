      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={cn(
            ...
            "bg-linear-to-br from-white/95 via-white/90 to-white/85 dark:from-gray-900/95 dark:via-gray-800/90 dark:to-gray-900/85 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 shadow-2xl shadow-purple-500/10 dark:shadow-purple-900/20",
            className,
          )}
        >
