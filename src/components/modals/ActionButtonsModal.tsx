      ...
      <DialogContent className="bg-linear-to-br from-purple-900 via-purple-800 to-blue-900 text-white border-purple-500/30 max-w-sm sm:max-w-md lg:max-w-lg max-h-[90vh] overflow-y-auto z-[100]">
        ...
        <div className="space-y-4 sm:space-y-6 text-white">
          <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/10 rounded-lg border border-white/20">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg text-white drop-shadow-md">
                Pasar (X)
              </h3>
              <p className="text-xs sm:text-sm text-white/90 font-medium leading-relaxed drop-shadow-sm">
                Usa este botón si no te interesa el perfil. No se enviará
                ninguna notificación y pasarás al siguiente.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/10 rounded-lg border border-white/20">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-white/90 font-medium leading-relaxed drop-shadow-sm">
                ¿Alguien te llamó mucho la atención? Envíale un Superlike para
                destacarte. ¡La otra persona sabrá que te interesa de verdad!
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/10 rounded-lg border border-white/20">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-white/90 font-medium leading-relaxed drop-shadow-sm">
                Si te gusta un perfil, dale 'Me Gusta'. Si la otra persona
                también te da 'Me Gusta', ¡es un match! Podrán empezar a
                chatear.
              </p>
            </div>
          </div>
