              ...
              {activeTab === "readme" ? (
                <div className="prose prose-invert max-w-none">
                  ...
                  <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4 mb-6">
                    ...
                    <p className="text-white">
                      <strong>Estado:</strong> ✅ PRODUCTION READY - AI-NATIVE -
                      ENTERPRISE GRADE - NEO4J OPERATIVO ✅<br />
                      <strong>Última Actualización:</strong> 05 de Noviembre,
                      2025
                      <br />
                      <strong>Versión:</strong> 3.5.0 - Features Innovadoras +
                      Neo4j + Documentación Consolidada
                      <br />
                      <strong>Puntuación Global:</strong> 87/100 - ✅ Production
                      Ready
                    </p>
                  </div>

                  <blockquote className="border-l-4 border-purple-500 pl-4 italic text-xl text-white/90 mb-8">
                    La plataforma de intercambio de parejas ms exclusiva y
                    segura de Mxico +18
                  </blockquote>
                  ...
                  <p className="text-white/90 mb-6">
                    ComplicesConecta es más que una aplicación de citas: es una
                  ...
                  <h3 className="text-xl font-semibold text-purple-400 mb-3">
                    🤖 Sistema de Matches Inteligente con IA
                  </h3>
                  <ul className="text-white/90 mb-4 space-y-2">
                    <li>
                      {" "}
                      Algoritmo basado en Big Five + traits especficos swinger
                    </li>
                    <li>
                      {" "}
                      Scoring de compatibilidad con análisis multifactorial
                    </li>
                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <h2 className="text-2xl font-bold text-green-400 mb-4">
                    v3.5.0 - Features Innovadoras + Neo4j (Actual)
                  </h2>
                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-4 mb-6">
                    ...
                    <p className="text-white">
                      Aydanos a mantener ComplicesConecta como una comunidad
                      segura y respetuosa.
                    </p>
                  </div>

                  <h2 className="text-2xl font-bold text-white mb-4">
                    ?? Qu hace un Moderador?
                  </h2>
                  <ul className="text-white/90 mb-6 space-y-2">
                ...
                <Dialog>
                  ...
                  <DialogContent className="bg-gray-900 border-white/20 max-w-4xl max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="text-white/90 space-y-4">
                      ...
                      <p>
                        React 18.3.1, TypeScript, Tailwind CSS, Supabase,
                        PostgreSQL
                      </p>
      ...
      <DialogContent className="bg-gray-900 border-white/20 max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start space-x-2">
            ...
            />
            <Label
              htmlFor="terminos-mod"
              className="text-white/90 text-sm leading-relaxed"
            >
              Acepto los trminos y condiciones del programa de moderadores.
              Entiendo que es una posicin de responsabilidad voluntaria y me
              comprometo a mantener la confidencialidad y seguir las polticas de
              la comunidad.
            </Label>
          </div>
