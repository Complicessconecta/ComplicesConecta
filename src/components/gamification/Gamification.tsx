...
export const Gamification = () => {
  ...
  const experiencePercentage =
    (mockStats.experience / mockStats.nextLevelExp) * 100;
    ...
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">
                    Envía un mensaje a un nuevo match
                  </p>
                </div>
              </div>
              <div className="text-right">
            ...
            <div className="flex items-center justify-between p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">
                    Actualiza tu biografía o fotos
                  </p>
                </div>
              </div>
              <div className="text-right">
      ...
      <Card className="shadow-soft bg-white/10 backdrop-blur-md border border-white/20">
        ...
        <CardContent>
            ...
            {[
              ...
              >
                <div className="flex items-center space-x-3">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                      user.rank === 1
                        ...
                        : user.rank === 2
                          ? "bg-gray-400/30 text-gray-200 border border-gray-400/50"
                          : user.rank === 3
                            ? "bg-orange-400/30 text-orange-200 border border-orange-400/50"
                  ...
                  <div>
                    <p
                      className={`font-medium ${user.isCurrentUser ? "text-purple-300" : "text-white"}`}
                    >
          ...
          <Button
            variant="outline"
            className="w-full mt-4 border-purple-400/50 text-purple-300 hover:bg-purple-500/20 hover:text-white"
          >
            Ver Tabla Completa
          </Button>
        </CardContent>
