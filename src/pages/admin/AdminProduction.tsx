...
const AdminProduction = () => {
  ...
  useEffect(() => {
    ...
    // CRÃTICO: No verificar autenticaciÃ³n si aÃºn estÃ¡ cargando
    if (loading) {
    ...
    logger.info('ðŸ” Estado autenticaciÃ³n:', { status: authStatus });
  ...
  const loadProductionData = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Error al cargar datos del panel de administraciÃ³n de producciÃ³n",
        variant: "destructive"
      });
    } finally {
  ...
  const loadRealStats = async () => {
    try {
      ...
      logger.info('ðŸ“Š EstadÃ­sticas cargadas:', {
